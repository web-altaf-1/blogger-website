        ...
        <Slider className='slider-bg' {...settings} >
            <div className=' '>
                <div className='single-slider'>
                    <div className='left-banner-div'>
                        ...
                        <button className='banner-button shadow-lg'>আরো দেখুন</button>
                    </div>
                    <div className='right-banner-div'>
                        <img className='img-fluid' width='513px' height='360px' src={img1} alt="" />
                    </div>
                </div>
            ...
            <div className=' '>
                <div className='single-slider'>
                    ...
                    <div className='right-banner-div'>
                        <img className='img-fluid' width='513px' height='360px' src="https://trickbd.com/wp-content/uploads/2022/09/30/IMG_20220930_081721.jpg" alt="" />
                    </div>
                </div>
